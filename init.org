...
(use-package emacs
  ...
  (defcustom avi/variable-pitch-font-family "Aporetic Sans Mono"
  ...
  (defun avi/set-font-size ()
  	(interactive)
  	;; Main typeface
  	(set-face-attribute 'default nil :family avi/default-font-family :height 160)
...
(use-package general
  ...
  (avi/leader-keys
	...
	"le" '(flymake-show-buffer-diagnostics :which-key "flymake-buffer")
	"lE" '(flymake-show-project-diagnostics :which-key "flymake-project")
